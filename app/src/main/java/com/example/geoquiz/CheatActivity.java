...
public class CheatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showApiLevel = (TextView) findViewById(R.id.showAPI);
    ...
    public static Intent newInten(Context pakageContext, boolean answerIsTrue) {
    ...
    public void showAPIS(TextView showApiLevel){
        System.out.println("Version API: " + Build.VERSION.SDK_INT);
    }
}